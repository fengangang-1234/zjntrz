...
// --------------------------------------------------------------------------- 
    ...
    action forward(bit<9> mac_port){
        ...
        hdr.ipv4.src_addr = ig_md.timestamp_32;
    ...
    action get_timestamp(){
        ...
        ig_md.timestamp_32 = ig_prsr_md.global_tstamp[31:0];
...
// ---------------------------------------------------------------------------
    ...
    Register<bit<16>,_>(65536) token_bucket_update_time_reg4;
    Register<bit<8>,_>(65536) connect_token_bucket_reg4;

    RegisterAction<bit<16>, _, bit<1>>(token_bucket_update_time_reg4) check_last_update_time_regact4 = {
        void apply(inout bit<16> value, out bit<1> read_value){
            read_value =0;
            if(ig_md.timestamp_16-value > 5){
                read_value = 1;
    ...
    RegisterAction<bit<8>, _, bit<1>>(connect_token_bucket_reg4) check_token_bucket_regact4 = {
        void apply(inout bit<8> value, out bit<1> read_value){
            read_value = 0;
            if(ig_md.update_flag3 == 1){
                value = ig_md.tocken_conf -1;
    ...
    Register<bit<16>,_>(65536) token_bucket_update_time_reg5;
    Register<bit<8>,_>(65536) connect_token_bucket_reg5;

    RegisterAction<bit<16>, _, bit<1>>(token_bucket_update_time_reg5) check_last_update_time_regact5 = {
        void apply(inout bit<16> value, out bit<1> read_value){
            read_value =0;
            if(ig_md.timestamp_16-value > 5){
                read_value = 1;
    ...
    RegisterAction<bit<8>, _, bit<1>>(connect_token_bucket_reg5) check_token_bucket_regact5 = {
        void apply(inout bit<8> value, out bit<1> read_value){
            read_value = 0;
            if(ig_md.update_flag3 == 1){
                value = ig_md.tocken_conf -1;
    ...
    Register<bit<16>,_>(65536) token_bucket_update_time_reg6;
    Register<bit<8>,_>(65536) connect_token_bucket_reg6;

    RegisterAction<bit<16>, _, bit<1>>(token_bucket_update_time_reg6) check_last_update_time_regact6 = {
        void apply(inout bit<16> value, out bit<1> read_value){
            read_value =0;
            if(ig_md.timestamp_16-value > 5){
                read_value = 1;
    ...
    RegisterAction<bit<8>, _, bit<1>>(connect_token_bucket_reg6) check_token_bucket_regact6 = {
        void apply(inout bit<8> value, out bit<1> read_value){
            read_value = 0;
            if(ig_md.update_flag3 == 1){
                value = ig_md.tocken_conf -1;
    ...
    Register<bit<16>,_>(65536) token_bucket_update_time_reg7;
    Register<bit<8>,_>(65536) connect_token_bucket_reg7;

    RegisterAction<bit<16>, _, bit<1>>(token_bucket_update_time_reg7) check_last_update_time_regact7 = {
        void apply(inout bit<16> value, out bit<1> read_value){
            read_value =0;
            if(ig_md.timestamp_16-value > 5){
                read_value = 1;
    ...
    RegisterAction<bit<8>, _, bit<1>>(connect_token_bucket_reg7) check_token_bucket_regact7 = {
        void apply(inout bit<8> value, out bit<1> read_value){
            read_value = 0;
            if(ig_md.update_flag3 == 1){
                value = ig_md.tocken_conf -1;
    ...
    Register<bit<16>,_>(65536) token_bucket_update_time_reg8;
    Register<bit<8>,_>(65536) connect_token_bucket_reg8;

    RegisterAction<bit<16>, _, bit<1>>(token_bucket_update_time_reg8) check_last_update_time_regact8 = {
        void apply(inout bit<16> value, out bit<1> read_value){
            read_value =0;
            if(ig_md.timestamp_16-value > 5){
                read_value = 1;
    ...
    RegisterAction<bit<8>, _, bit<1>>(connect_token_bucket_reg8) check_token_bucket_regact8 = {
        void apply(inout bit<8> value, out bit<1> read_value){
            read_value = 0;
            if(ig_md.update_flag3 == 1){
                value = ig_md.tocken_conf -1;
    ...
    Register<bit<16>,_>(65536) token_bucket_update_time_reg9;
    Register<bit<8>,_>(65536) connect_token_bucket_reg9;

    RegisterAction<bit<16>, _, bit<1>>(token_bucket_update_time_reg9) check_last_update_time_regact9 = {
        void apply(inout bit<16> value, out bit<1> read_value){
            read_value =0;
            if(ig_md.timestamp_16-value > 5){
                read_value = 1;
    ...
    RegisterAction<bit<8>, _, bit<1>>(connect_token_bucket_reg9) check_token_bucket_regact9 = {
        void apply(inout bit<8> value, out bit<1> read_value){
            read_value = 0;
            if(ig_md.update_flag3 == 1){
                value = ig_md.tocken_conf -1;
    ...
    Register<bit<16>,_>(65536) token_bucket_update_time_reg10;
    Register<bit<8>,_>(65536) connect_token_bucket_reg10;

    RegisterAction<bit<16>, _, bit<1>>(token_bucket_update_time_reg10) check_last_update_time_regact10 = {
        void apply(inout bit<16> value, out bit<1> read_value){
            read_value =0;
            if(ig_md.timestamp_16-value > 5){
                read_value = 1;
    ...
    RegisterAction<bit<8>, _, bit<1>>(connect_token_bucket_reg10) check_token_bucket_regact10 = {
        void apply(inout bit<8> value, out bit<1> read_value){
            read_value = 0;
            if(ig_md.update_flag3 == 1){
                value = ig_md.tocken_conf -1;
    ...
    action check_tocken_bucket_update4(){
        ig_md.update_flag4 = check_last_update_time_regact4.execute(ig_md.hashb_16_val3);
    }
    action check_token_num4(){
        ig_md.ret4=check_token_bucket_regact4.execute(ig_md.hashb_16_val3);
    }
    action check_tocken_bucket_update5(){
        ig_md.update_flag5 = check_last_update_time_regact5.execute(ig_md.hashb_16_val3);
    }
    action check_token_num5(){
        ig_md.ret5=check_token_bucket_regact5.execute(ig_md.hashb_16_val3);
    }
    action check_tocken_bucket_update7(){
        ig_md.update_flag7 = check_last_update_time_regact7.execute(ig_md.hashb_16_val3);
    }
    action check_token_num7(){
        ig_md.ret7=check_token_bucket_regact7.execute(ig_md.hashb_16_val3);
    }
    action check_tocken_bucket_update6(){
        ig_md.update_flag6 = check_last_update_time_regact6.execute(ig_md.hashb_16_val3);
    }
    action check_token_num6(){
        ig_md.ret6=check_token_bucket_regact6.execute(ig_md.hashb_16_val3);
    }

    action check_tocken_bucket_update8(){
        ig_md.update_flag8 = check_last_update_time_regact8.execute(ig_md.hashb_16_val3);
    }
    action check_token_num8(){
        ig_md.ret8=check_token_bucket_regact8.execute(ig_md.hashb_16_val3);
    }
    action check_tocken_bucket_update9(){
        ig_md.update_flag9 = check_last_update_time_regact9.execute(ig_md.hashb_16_val3);
    }
    action check_token_num9(){
        ig_md.ret9=check_token_bucket_regact9.execute(ig_md.hashb_16_val3);
    }

    action check_tocken_bucket_update10(){
        ig_md.update_flag10 = check_last_update_time_regact10.execute(ig_md.hashb_16_val3);
    }
    action check_token_num10(){
        ig_md.ret10=check_token_bucket_regact10.execute(ig_md.hashb_16_val3);
    }
...
// ---------------------------------------------------------------------------  
    ...
    action test(){
        hdr.ipv4.src_addr = ig_md.timestamp_32;
        // hdr.ipv4.dst_addr =(bit<32>) ig_md.remain_len_ret;
        // ig_tm_md.ucast_egress_port = 149;
        // ig_tm_md.bypass_egress=1;
    }
    // action test(){
    //     hdr.tcp.src_port = (bit<16>) ig_md.access_flag;
    //     ig_tm_md.ucast_egress_port = 149;
    //     ig_tm_md.bypass_egress=1;
    // }
    ...
    apply {
        ...
        if (hdr.tcp.isValid() && hdr.mqtt.isValid()){         
            ...
            if (ig_md.blacklist_in == 1){
                ...
                check_token_num3();
                check_tocken_bucket_update4();
                check_token_num4();
                check_tocken_bucket_update5();
                check_token_num5();
                check_tocken_bucket_update7();
                check_token_num7();
                check_tocken_bucket_update6();
                check_token_num6();
                check_tocken_bucket_update8();
                check_token_num8();
                check_tocken_bucket_update9();
                check_token_num9();
                check_tocken_bucket_update10();
                check_token_num10();
