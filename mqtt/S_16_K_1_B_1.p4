...
// --------------------------------------------------------------------------- 
    ...
    CRCPolynomial<bit<10>>(10w0xB03, // polynomial
                           false,        // reversed
                           false,        // use msb?
                           false,        // extended?
                           10w0xFFF,    // initial shift register value
                           10w0x000     // result xor
                           ) polya3;
    Hash<bit<10>>(HashAlgorithm_t.CUSTOM, polya3) crca16_3;
...
// ---------------------------------------------------------------------------  
    ...
    Register<bit<32>,_>(1024) ip_cache_reg;
    Register<bit<16>,_>(1024) port_cache_reg;
    Register<bit<16>,_>(1024) time_cache_reg;
